	...
	<div class="card shadow mb-4">
		...
		<div class="card-header py-3">
			<div class="d-sm-flex align-items-center justify-content-between">
				<h6 class="m-0 font-weight-bold text-success"><i class="fa fa-table"></i>
					<?= $key->keterangan . " (" . $key->kode_kriteria . ")" ?>
				</h6>

				<!-- tambah data dihide dulu supaya id nilai default tidak berubah -->
				<!-- <a href="#tambah<?= $key->id_kriteria ?>" data-toggle="modal" class="btn btn-sm btn-success"> <i
				...
				<table class="table table-bordered" width="100%" cellspacing="0">
					...
					<tbody>
						...
						foreach ($sub_kriteria1 as $key):
							?>
							<?php if ($key['deskripsi'] != 'Tidak Ada') { ?>
								<tr align="center">
									<td>
										<?= $no ?>
									</td>
									...
									<td>
										...
										<div class="btn-group" role="group">
											<a data-toggle="modal" title="Edit Data" href="#editsk<?= $key['id_sub_kriteria'] ?>"
												...
												<!-- hapus sub kriteria dihide supaya nilai penilaian default tidak berubah -->
