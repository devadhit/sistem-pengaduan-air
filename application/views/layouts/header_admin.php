    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php if ($this->session->userdata('id_user_level') == '1' || $this->session->userdata('id_user_level') == '3'): ?>
                ...
                <li class="nav-item <?php if ($this->input->get('status') != '') {
                    echo 'active';
                } ?>">
                    ...
                    <div id="pengaduan" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item <?php if ($this->input->get('status') == 'belum_ditangani') {
                                echo 'active';
                            } ?>" href="<?= base_url('pengaduan?status=belum_ditangani&tanggal_dibuat='.date('Y-m-d').'') ?>">Belum Ditangani</a>
                            <a class="collapse-item <?php if ($this->input->get('status') == 'sedang_ditangani') {
                                echo 'active';
                            } ?>" href="<?= base_url('pengaduan?status=sedang_ditangani&tanggal_dibuat='.date('Y-m-d').'') ?>">Sedang Ditangani</a>
                            <a class="collapse-item <?php if ($this->input->get('status') == 'sudah_ditangani') {
                                echo 'active';
                            } ?>" href="<?= base_url('pengaduan?status=sudah_ditangani&tanggal_dibuat='.date('Y-m-d').'') ?>">Sudah Ditangani</a>
                        </div>
                    </div>
                </li>
                <?php if ($this->session->userdata('id_user_level') == '3'): ?>
                    ...
                    <li class="nav-item <?php if ($page == 'Penilaian') {
                        ...
                        <a class="nav-link" href="<?= base_url('Penilaian'); ?>">
                            ...
                            <span>Penilaian Pengaduan</span></a>
                    </li>
                    ...
                    <li class="nav-item <?php if ($page == 'Perhitungan') {
                        ...
                        <a class="nav-link" href="<?= base_url('Perhitungan'); ?>">
                            ...
                            <span>Perhitungan Prioritas</span></a>
                    </li>
                    ...
                    <li class="nav-item <?php if ($page == 'Hasil') {
                        ...
                        <a class="nav-link" href="<?= base_url('Perhitungan/hasil'); ?>">
                            ...
                            <span>Hasil Perhitungan Prioritas</span></a>
                    </li>
                <?php endif; ?>
            ...
            <!-- SOP untuk admin dan Petugas -->
            <li class="nav-item <?php if ($page == 'SOP') {
                echo 'active';
            } ?>">
                <a class="nav-link" href="<?= base_url('SOP'); ?>">
                    <i class="fas fa-fw fa-file"></i>
                    <span>Data SOP</span></a>
            </li>


            <!-- kualitas air dan pemeriksaan sarana untuk petugas -->
            <?php if ($this->session->userdata('id_user_level') == '3'): ?>

                <li class="nav-item <?php if ($page == 'Sarana') {
                    echo 'active';
                } ?>">
                    <a class="nav-link" href="<?= base_url('Sarana'); ?>">
                        <i class="fas fa-fw fa-toolbox"></i>
                        <span>Data Pemeriksaan Sarana</span></a>
                </li>

                <li class="nav-item <?php if ($page == 'Pengaduan/evaluasi') {
                    echo 'active';
                } ?>">
                    <a class="nav-link" href="<?= base_url('Pengaduan/evaluasi'); ?>">
                        <i class="fas fa-fw fa-toolbox"></i>
                        <span>Data Evaluasi</span></a>
                </li>
            <?php endif; ?>


            <?php if ($this->session->userdata('id_user_level') == '1'): ?>
                <li class="nav-item <?php if ($page == 'Data Lokasi') {
                    echo 'active';
                } ?>">
                    <a class="nav-link" href="<?= base_url('Data_Lokasi'); ?>">
            ...
            <?php if ($this->session->userdata('id_user_level') == '1'): ?>
                ...
                <li class="nav-item <?php if ($page == 'Petugas') {
                    echo 'active';
                } ?>">
