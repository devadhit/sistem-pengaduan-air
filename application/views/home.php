...
<body>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="100" style="text-align: center; ">
            <h1 style="line-height: 30px;"> <span style="font-size:28px; ">LAYANAN PENGADUAN
                    <br> PERUMDA AIR MINUM
                    TIRTA RANGGA <br> KABUPATEN SUBANG
                </span></h1>
            <h1> <span style="font-size:14px;">Sampaikan laporan masalah Anda kepada kami, Kami akan memprosesnya dengan
                    cepat.</span></h1>

                    <!-- <a href="<?= base_url('form_aduan/buat_laporan') ?>" -->
            <a href="<?= base_url('daftar_pengaduan') ?>"
                style="border-radius:10px; background-color:orange; padding-left:15px; padding-top:3px; padding-bottom:5px; padding-right:15px; color:white;"><span
                    style="font-size:14px;">Lihat daftar pengaduan anda disini →</span> </a>
