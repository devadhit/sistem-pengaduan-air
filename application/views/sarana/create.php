...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-success"><i class="fas fa-fw fa-plus"></i> Tambah Data Sarana</h6>
    </div>
	
	<?php echo form_open('Sarana/store'); ?>
		<div class="card-body">
			<div class="row">
				...
				<div class="form-group col-md-6">
					...
					<input autocomplete="off" type="text" name="nama_sarana" required class="form-control"/>
				</div>
